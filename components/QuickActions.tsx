...
export function QuickActions({setQuickAction}:QuickActionProps) {
    ...
    <div className="hidden rounded-2xl bg-gradient-to-r from-[#201931a3] via-[#1a14287f] to-[#1611229a] backdrop-blur-xs md:flex flex-col p-5 gap-5 hover:shadow-xl hover:shadow-[#201931]/60">
      ...
      <div className="flex flex-col gap-4 justify-center">
        {actions.map((elem)=>{
          ...
          return (
            <div key={elem.name} className="flex gap-2 items-center p-2 border-2 border-[rgba(255,255,255,0)] hover:border-[#4d0e3bf5] rounded-2xl cursor-pointer hover:bg-[#4d0e3b17]" onClick={()=>handleQuickAction(elem.name)}>
